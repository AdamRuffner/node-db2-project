...
const Cars = {
  getAll() {
    return db("cars-updated");
  },
  getById(id) {
    return db("cars-updated").where({ id });
  },
  create(car) {
    return db("cars-updated").insert(car);
  },
  update(id, car) {
    return db("cars-updated").where({ id }).update(car);
  },
  delete(id) {
    return db("cars-updated").where({ id }).del();
  },
};
